...
if __name__ == "__main__":
    ...
    #-----------------------------------------------------#
    #input_shape = [512, 512]
    input_shape = [512, 640]  # height=512, width=640
    #----------------------------------------------------------------------------------------------------------------------------#
    ...
    cls_weights = np.array([1, 10000], np.float32)
    #------------------------------------------------------------------#
    ...
    if True:
        ...
        if optimizer_type == 'adam':
            ...
            optimizer = optim.SGD(trainable_params, Init_lr_fit, momentum=momentum, nesterov=True,
